...
$config['modules']['blog_posts'] = array(
	...
	'permission' => array('blog_posts', 'blog_posts/create', 'blog_posts/edit', 'blog_posts/publish', 'blog_posts/delete'),
...
$config['modules']['blog_comments'] = array(
	...
	'default_order' => 'desc',
	'preview_path' => 'blog/{year}/{month}/{day}/{slug}',
	'permission' => array('blog_comments', 'blog_comments/create', 'blog_comments/edit', 'blog_comments/publish', 'blog_comments/delete'),
...
$config['modules']['blog_links'] = array(
	...
	'default_col' => 'name',
	'preview_path' => '',
	'permission' => array('blog_links', 'blog_links/create', 'blog_links/edit', 'blog_links/publish', 'blog_links/delete'),
